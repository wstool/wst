...
func (_m *MockCommand) SetSysProcAttr(attr *syscall.SysProcAttr) {
	_m.Called(attr)
}
...
func (_c *MockCommand_SetSysProcAttr_Call) Run(run func(attr *syscall.SysProcAttr)) *MockCommand_SetSysProcAttr_Call {
	_c.Call.Run(func(args mock.Arguments) {
		run(args[0].(*syscall.SysProcAttr))
	})
	return _c
}
...
func (_c *MockCommand_SetSysProcAttr_Call) RunAndReturn(run func(*syscall.SysProcAttr)) *MockCommand_SetSysProcAttr_Call {
	_c.Call.Return(run)
	return _c
}
