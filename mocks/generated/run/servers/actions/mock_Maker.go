...
func (_mock *MockMaker) Make(configActions *types.ServerActions) (*actions.Actions, error) {
	ret := _mock.Called(configActions)
	...
	var r1 error
	if returnFunc, ok := ret.Get(0).(func(*types.ServerActions) (*actions.Actions, error)); ok {
		return returnFunc(configActions)
	}
	if returnFunc, ok := ret.Get(0).(func(*types.ServerActions) *actions.Actions); ok {
		r0 = returnFunc(configActions)
	} else {
		if ret.Get(0) != nil {
			r0 = ret.Get(0).(*actions.Actions)
		}
	}
	if returnFunc, ok := ret.Get(1).(func(*types.ServerActions) error); ok {
		r1 = returnFunc(configActions)
	} else {
		r1 = ret.Error(1)
	}
	return r0, r1
...
func (_c *MockMaker_Make_Call) Run(run func(configActions *types.ServerActions)) *MockMaker_Make_Call {
	_c.Call.Run(func(args mock.Arguments) {
		var arg0 *types.ServerActions
		if args[0] != nil {
			arg0 = args[0].(*types.ServerActions)
		}
		run(
			arg0,
		)
...
func (_c *MockMaker_Make_Call) Return(actions1 *actions.Actions, err error) *MockMaker_Make_Call {
	_c.Call.Return(actions1, err)
	return _c
}

func (_c *MockMaker_Make_Call) RunAndReturn(run func(configActions *types.ServerActions) (*actions.Actions, error)) *MockMaker_Make_Call {
	_c.Call.Return(run)
	return _c
}
