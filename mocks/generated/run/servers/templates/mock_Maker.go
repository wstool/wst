...
func (_mock *MockMaker) Make(config map[string]types.ServerTemplate) (templates.Templates, error) {
	...
	var r1 error
	if returnFunc, ok := ret.Get(0).(func(map[string]types.ServerTemplate) (templates.Templates, error)); ok {
		return returnFunc(config)
	}
	if returnFunc, ok := ret.Get(0).(func(map[string]types.ServerTemplate) templates.Templates); ok {
	...
	if returnFunc, ok := ret.Get(1).(func(map[string]types.ServerTemplate) error); ok {
...
func (_c *MockMaker_Make_Call) Run(run func(config map[string]types.ServerTemplate)) *MockMaker_Make_Call {
	_c.Call.Run(func(args mock.Arguments) {
		var arg0 map[string]types.ServerTemplate
		if args[0] != nil {
			arg0 = args[0].(map[string]types.ServerTemplate)
		}
		run(
			arg0,
		)
...
func (_c *MockMaker_Make_Call) Return(templates1 templates.Templates, err error) *MockMaker_Make_Call {
	_c.Call.Return(templates1, err)
	return _c
}

func (_c *MockMaker_Make_Call) RunAndReturn(run func(config map[string]types.ServerTemplate) (templates.Templates, error)) *MockMaker_Make_Call {
	_c.Call.Return(run)
	return _c
}
