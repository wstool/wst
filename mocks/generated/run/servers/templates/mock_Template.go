...
// FilePath provides a mock function for the type MockTemplate
func (_mock *MockTemplate) FilePath() string {
	ret := _mock.Called()
...
func (_c *MockTemplate_FilePath_Call) Return(s string) *MockTemplate_FilePath_Call {
	_c.Call.Return(s)
	return _c
}
