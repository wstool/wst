...
func (_mock *MockMaker) Make(config map[string]types.ServerConfig) (configs.Configs, error) {
	...
	var r1 error
	if returnFunc, ok := ret.Get(0).(func(map[string]types.ServerConfig) (configs.Configs, error)); ok {
		return returnFunc(config)
	}
	if returnFunc, ok := ret.Get(0).(func(map[string]types.ServerConfig) configs.Configs); ok {
	...
	if returnFunc, ok := ret.Get(1).(func(map[string]types.ServerConfig) error); ok {
...
func (_c *MockMaker_Make_Call) Run(run func(config map[string]types.ServerConfig)) *MockMaker_Make_Call {
	_c.Call.Run(func(args mock.Arguments) {
		var arg0 map[string]types.ServerConfig
		if args[0] != nil {
			arg0 = args[0].(map[string]types.ServerConfig)
		}
		run(
			arg0,
		)
...
func (_c *MockMaker_Make_Call) Return(configs1 configs.Configs, err error) *MockMaker_Make_Call {
	_c.Call.Return(configs1, err)
	return _c
}

func (_c *MockMaker_Make_Call) RunAndReturn(run func(config map[string]types.ServerConfig) (configs.Configs, error)) *MockMaker_Make_Call {
	_c.Call.Return(run)
	return _c
}
