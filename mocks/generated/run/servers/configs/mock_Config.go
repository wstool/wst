...
// FilePath provides a mock function for the type MockConfig
func (_mock *MockConfig) FilePath() string {
	ret := _mock.Called()
...
func (_c *MockConfig_FilePath_Call) Return(s string) *MockConfig_FilePath_Call {
	_c.Call.Return(s)
	return _c
}
...
// Parameters provides a mock function for the type MockConfig
func (_mock *MockConfig) Parameters() parameters.Parameters {
	ret := _mock.Called()
...
func (_c *MockConfig_Parameters_Call) Return(parameters1 parameters.Parameters) *MockConfig_Parameters_Call {
