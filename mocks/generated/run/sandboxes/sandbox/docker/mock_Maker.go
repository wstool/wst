...
func (_mock *MockMaker) MakeSandbox(config *types.DockerSandbox) (sandbox.Sandbox, error) {
	...
	var r1 error
	if returnFunc, ok := ret.Get(0).(func(*types.DockerSandbox) (sandbox.Sandbox, error)); ok {
		return returnFunc(config)
	}
	if returnFunc, ok := ret.Get(0).(func(*types.DockerSandbox) sandbox.Sandbox); ok {
	...
	if returnFunc, ok := ret.Get(1).(func(*types.DockerSandbox) error); ok {
...
func (_c *MockMaker_MakeSandbox_Call) Run(run func(config *types.DockerSandbox)) *MockMaker_MakeSandbox_Call {
	_c.Call.Run(func(args mock.Arguments) {
		var arg0 *types.DockerSandbox
		if args[0] != nil {
			arg0 = args[0].(*types.DockerSandbox)
		}
		run(
			arg0,
		)
...
func (_c *MockMaker_MakeSandbox_Call) RunAndReturn(run func(config *types.DockerSandbox) (sandbox.Sandbox, error)) *MockMaker_MakeSandbox_Call {
	_c.Call.Return(run)
	return _c
}
