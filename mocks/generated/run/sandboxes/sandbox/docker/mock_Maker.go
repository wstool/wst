...
func (_m *MockMaker) MakeSandbox(config *types.DockerSandbox) (sandbox.Sandbox, error) {
	...
	var r1 error
	if rf, ok := ret.Get(0).(func(*types.DockerSandbox) (sandbox.Sandbox, error)); ok {
		return rf(config)
	}
	if rf, ok := ret.Get(0).(func(*types.DockerSandbox) sandbox.Sandbox); ok {
		r0 = rf(config)
	} else {
		if ret.Get(0) != nil {
	...
	if rf, ok := ret.Get(1).(func(*types.DockerSandbox) error); ok {
		r1 = rf(config)
	} else {
		r1 = ret.Error(1)
	}
...
func (_c *MockMaker_MakeSandbox_Call) Run(run func(config *types.DockerSandbox)) *MockMaker_MakeSandbox_Call {
	_c.Call.Run(func(args mock.Arguments) {
		run(args[0].(*types.DockerSandbox))
	})
	return _c
}
...
func (_c *MockMaker_MakeSandbox_Call) RunAndReturn(run func(*types.DockerSandbox) (sandbox.Sandbox, error)) *MockMaker_MakeSandbox_Call {
	_c.Call.Return(run)
	return _c
}
