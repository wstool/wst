...
import (
	...
	common "github.com/wstool/wst/run/sandboxes/sandbox/common"
...
func (_m *MockMaker) MakeSandbox(config *types.CommonSandbox) (*common.Sandbox, error) {
	...
	var r1 error
	if rf, ok := ret.Get(0).(func(*types.CommonSandbox) (*common.Sandbox, error)); ok {
		return rf(config)
	}
	if rf, ok := ret.Get(0).(func(*types.CommonSandbox) *common.Sandbox); ok {
		r0 = rf(config)
	} else {
		if ret.Get(0) != nil {
	...
	if rf, ok := ret.Get(1).(func(*types.CommonSandbox) error); ok {
		r1 = rf(config)
	} else {
		r1 = ret.Error(1)
	}
...
func (_c *MockMaker_MakeSandbox_Call) Run(run func(config *types.CommonSandbox)) *MockMaker_MakeSandbox_Call {
	_c.Call.Run(func(args mock.Arguments) {
		run(args[0].(*types.CommonSandbox))
	})
	return _c
}

func (_c *MockMaker_MakeSandbox_Call) Return(_a0 *common.Sandbox, _a1 error) *MockMaker_MakeSandbox_Call {
	_c.Call.Return(_a0, _a1)
	return _c
}

func (_c *MockMaker_MakeSandbox_Call) RunAndReturn(run func(*types.CommonSandbox) (*common.Sandbox, error)) *MockMaker_MakeSandbox_Call {
	_c.Call.Return(run)
	return _c
}
