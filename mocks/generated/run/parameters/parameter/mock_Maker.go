...
func (_mock *MockMaker) Make(config interface{}) (parameter.Parameter, error) {
	...
	var r1 error
	if returnFunc, ok := ret.Get(0).(func(interface{}) (parameter.Parameter, error)); ok {
		return returnFunc(config)
	}
	if returnFunc, ok := ret.Get(0).(func(interface{}) parameter.Parameter); ok {
...
func (_c *MockMaker_Make_Call) Return(parameter1 parameter.Parameter, err error) *MockMaker_Make_Call {
	_c.Call.Return(parameter1, err)
	return _c
}

func (_c *MockMaker_Make_Call) RunAndReturn(run func(config interface{}) (parameter.Parameter, error)) *MockMaker_Make_Call {
	_c.Call.Return(run)
	return _c
}
