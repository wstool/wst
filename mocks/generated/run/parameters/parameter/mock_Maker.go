...
func (_m *MockMaker) Make(config interface{}) (parameter.Parameter, error) {
	...
	var r1 error
	if rf, ok := ret.Get(0).(func(interface{}) (parameter.Parameter, error)); ok {
		return rf(config)
	}
	if rf, ok := ret.Get(0).(func(interface{}) parameter.Parameter); ok {
		r0 = rf(config)
	} else {
		if ret.Get(0) != nil {
...
func (_c *MockMaker_Make_Call) Return(_a0 parameter.Parameter, _a1 error) *MockMaker_Make_Call {
