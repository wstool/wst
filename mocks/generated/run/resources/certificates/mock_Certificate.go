...
// CertificateData provides a mock function with given fields:
func (_m *MockCertificate) CertificateData() string {
	ret := _m.Called()
...
func (_c *MockCertificate_CertificateData_Call) Return(_a0 string) *MockCertificate_CertificateData_Call {
	_c.Call.Return(_a0)
	return _c
}
...
// CertificateName provides a mock function with given fields:
func (_m *MockCertificate) CertificateName() string {
	ret := _m.Called()
...
func (_c *MockCertificate_CertificateName_Call) Return(_a0 string) *MockCertificate_CertificateName_Call {
	_c.Call.Return(_a0)
	return _c
}
...
// PrivateKeyData provides a mock function with given fields:
func (_m *MockCertificate) PrivateKeyData() string {
	ret := _m.Called()
...
func (_c *MockCertificate_PrivateKeyData_Call) Return(_a0 string) *MockCertificate_PrivateKeyData_Call {
	_c.Call.Return(_a0)
	return _c
}
...
// PrivateKeyName provides a mock function with given fields:
func (_m *MockCertificate) PrivateKeyName() string {
	ret := _m.Called()
...
func (_c *MockCertificate_PrivateKeyName_Call) Return(_a0 string) *MockCertificate_PrivateKeyName_Call {
	_c.Call.Return(_a0)
	return _c
}
