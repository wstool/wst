...
func (_mock *MockMaker) Make(config map[string]types.Certificate) (certificates.Certificates, error) {
	...
	var r1 error
	if returnFunc, ok := ret.Get(0).(func(map[string]types.Certificate) (certificates.Certificates, error)); ok {
		return returnFunc(config)
	}
	if returnFunc, ok := ret.Get(0).(func(map[string]types.Certificate) certificates.Certificates); ok {
	...
	if returnFunc, ok := ret.Get(1).(func(map[string]types.Certificate) error); ok {
...
func (_c *MockMaker_Make_Call) Run(run func(config map[string]types.Certificate)) *MockMaker_Make_Call {
	_c.Call.Run(func(args mock.Arguments) {
		var arg0 map[string]types.Certificate
		if args[0] != nil {
			arg0 = args[0].(map[string]types.Certificate)
		}
		run(
			arg0,
		)
...
func (_c *MockMaker_Make_Call) Return(certificates1 certificates.Certificates, err error) *MockMaker_Make_Call {
	_c.Call.Return(certificates1, err)
	return _c
}

func (_c *MockMaker_Make_Call) RunAndReturn(run func(config map[string]types.Certificate) (certificates.Certificates, error)) *MockMaker_Make_Call {
	_c.Call.Return(run)
	return _c
}
