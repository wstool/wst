...
func (_m *MockMaker) Make(config types.Resources) (*resources.Resources, error) {
	...
	var r1 error
	if rf, ok := ret.Get(0).(func(types.Resources) (*resources.Resources, error)); ok {
		return rf(config)
	}
	if rf, ok := ret.Get(0).(func(types.Resources) *resources.Resources); ok {
		r0 = rf(config)
	} else {
		if ret.Get(0) != nil {
	...
	if rf, ok := ret.Get(1).(func(types.Resources) error); ok {
		r1 = rf(config)
	} else {
		r1 = ret.Error(1)
	}
...
func (_c *MockMaker_Make_Call) Run(run func(config types.Resources)) *MockMaker_Make_Call {
	_c.Call.Run(func(args mock.Arguments) {
		run(args[0].(types.Resources))
	})
	return _c
}

func (_c *MockMaker_Make_Call) Return(_a0 *resources.Resources, _a1 error) *MockMaker_Make_Call {
	_c.Call.Return(_a0, _a1)
	return _c
}

func (_c *MockMaker_Make_Call) RunAndReturn(run func(types.Resources) (*resources.Resources, error)) *MockMaker_Make_Call {
	_c.Call.Return(run)
	return _c
}
