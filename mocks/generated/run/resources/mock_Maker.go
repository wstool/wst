...
func (_mock *MockMaker) Make(config types.Resources) (*resources.Resources, error) {
	...
	var r1 error
	if returnFunc, ok := ret.Get(0).(func(types.Resources) (*resources.Resources, error)); ok {
		return returnFunc(config)
	}
	if returnFunc, ok := ret.Get(0).(func(types.Resources) *resources.Resources); ok {
	...
	if returnFunc, ok := ret.Get(1).(func(types.Resources) error); ok {
...
func (_c *MockMaker_Make_Call) Run(run func(config types.Resources)) *MockMaker_Make_Call {
	_c.Call.Run(func(args mock.Arguments) {
		var arg0 types.Resources
		if args[0] != nil {
			arg0 = args[0].(types.Resources)
		}
		run(
			arg0,
		)
...
func (_c *MockMaker_Make_Call) Return(resources1 *resources.Resources, err error) *MockMaker_Make_Call {
	_c.Call.Return(resources1, err)
	return _c
}

func (_c *MockMaker_Make_Call) RunAndReturn(run func(config types.Resources) (*resources.Resources, error)) *MockMaker_Make_Call {
	_c.Call.Return(run)
	return _c
}
