...
func (_m *MockMaker) Make(config *types.SpecDefaults) (*defaults.Defaults, error) {
	...
	var r1 error
	if rf, ok := ret.Get(0).(func(*types.SpecDefaults) (*defaults.Defaults, error)); ok {
		return rf(config)
	}
	if rf, ok := ret.Get(0).(func(*types.SpecDefaults) *defaults.Defaults); ok {
		r0 = rf(config)
	} else {
		if ret.Get(0) != nil {
	...
	if rf, ok := ret.Get(1).(func(*types.SpecDefaults) error); ok {
		r1 = rf(config)
	} else {
		r1 = ret.Error(1)
	}
...
func (_c *MockMaker_Make_Call) Run(run func(config *types.SpecDefaults)) *MockMaker_Make_Call {
	_c.Call.Run(func(args mock.Arguments) {
		run(args[0].(*types.SpecDefaults))
	})
	return _c
}

func (_c *MockMaker_Make_Call) Return(_a0 *defaults.Defaults, _a1 error) *MockMaker_Make_Call {
	_c.Call.Return(_a0, _a1)
	return _c
}

func (_c *MockMaker_Make_Call) RunAndReturn(run func(*types.SpecDefaults) (*defaults.Defaults, error)) *MockMaker_Make_Call {
	_c.Call.Return(run)
	return _c
}
