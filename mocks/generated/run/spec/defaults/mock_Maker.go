...
func (_mock *MockMaker) Make(config *types.SpecDefaults) (*defaults.Defaults, error) {
	...
	var r0 *defaults.Defaults
	var r1 error
	if returnFunc, ok := ret.Get(0).(func(*types.SpecDefaults) (*defaults.Defaults, error)); ok {
		return returnFunc(config)
	}
	if returnFunc, ok := ret.Get(0).(func(*types.SpecDefaults) *defaults.Defaults); ok {
		r0 = returnFunc(config)
	} else {
		if ret.Get(0) != nil {
			r0 = ret.Get(0).(*defaults.Defaults)
		}
	}
	if returnFunc, ok := ret.Get(1).(func(*types.SpecDefaults) error); ok {
...
func (_c *MockMaker_Make_Call) Run(run func(config *types.SpecDefaults)) *MockMaker_Make_Call {
	_c.Call.Run(func(args mock.Arguments) {
		var arg0 *types.SpecDefaults
		if args[0] != nil {
			arg0 = args[0].(*types.SpecDefaults)
		}
		run(
			arg0,
		)
...
func (_c *MockMaker_Make_Call) Return(defaults1 *defaults.Defaults, err error) *MockMaker_Make_Call {
	_c.Call.Return(defaults1, err)
	return _c
}

func (_c *MockMaker_Make_Call) RunAndReturn(run func(config *types.SpecDefaults) (*defaults.Defaults, error)) *MockMaker_Make_Call {
	_c.Call.Return(run)
	return _c
}
