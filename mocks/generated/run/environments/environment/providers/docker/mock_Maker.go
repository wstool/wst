...
func (_mock *MockMaker) Make(config *types.DockerEnvironment) (environment.Environment, error) {
	...
	var r1 error
	if returnFunc, ok := ret.Get(0).(func(*types.DockerEnvironment) (environment.Environment, error)); ok {
		return returnFunc(config)
	}
	if returnFunc, ok := ret.Get(0).(func(*types.DockerEnvironment) environment.Environment); ok {
	...
	if returnFunc, ok := ret.Get(1).(func(*types.DockerEnvironment) error); ok {
...
func (_c *MockMaker_Make_Call) Run(run func(config *types.DockerEnvironment)) *MockMaker_Make_Call {
	_c.Call.Run(func(args mock.Arguments) {
		var arg0 *types.DockerEnvironment
		if args[0] != nil {
			arg0 = args[0].(*types.DockerEnvironment)
		}
		run(
			arg0,
		)
...
func (_c *MockMaker_Make_Call) RunAndReturn(run func(config *types.DockerEnvironment) (environment.Environment, error)) *MockMaker_Make_Call {
	_c.Call.Return(run)
	return _c
}
