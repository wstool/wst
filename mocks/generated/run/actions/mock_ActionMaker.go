...
// MakeAction provides a mock function for the type MockActionMaker
func (_mock *MockActionMaker) MakeAction(config types.Action, sl services.ServiceLocator, defaultTimeout int) (action.Action, error) {
...
func (_c *MockActionMaker_MakeAction_Call) Return(action1 action.Action, err error) *MockActionMaker_MakeAction_Call {
	_c.Call.Return(action1, err)
	return _c
}

func (_c *MockActionMaker_MakeAction_Call) RunAndReturn(run func(config types.Action, sl services.ServiceLocator, defaultTimeout int) (action.Action, error)) *MockActionMaker_MakeAction_Call {
	_c.Call.Return(run)
	return _c
}
