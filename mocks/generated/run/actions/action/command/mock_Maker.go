...
func (_m *MockMaker) Make(config *types.CommandAction, sl services.ServiceLocator, defaultTimeout int) (action.Action, error) {
	...
	var r1 error
	if rf, ok := ret.Get(0).(func(*types.CommandAction, services.ServiceLocator, int) (action.Action, error)); ok {
		return rf(config, sl, defaultTimeout)
	}
	if rf, ok := ret.Get(0).(func(*types.CommandAction, services.ServiceLocator, int) action.Action); ok {
	...
	if rf, ok := ret.Get(1).(func(*types.CommandAction, services.ServiceLocator, int) error); ok {
...
func (_c *MockMaker_Make_Call) Run(run func(config *types.CommandAction, sl services.ServiceLocator, defaultTimeout int)) *MockMaker_Make_Call {
	_c.Call.Run(func(args mock.Arguments) {
		run(args[0].(*types.CommandAction), args[1].(services.ServiceLocator), args[2].(int))
	})
	return _c
}
...
func (_c *MockMaker_Make_Call) RunAndReturn(run func(*types.CommandAction, services.ServiceLocator, int) (action.Action, error)) *MockMaker_Make_Call {
	_c.Call.Return(run)
	return _c
}
