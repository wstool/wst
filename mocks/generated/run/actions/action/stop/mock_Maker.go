...
func (_mock *MockMaker) Make(config *types.StopAction, sl services.ServiceLocator, defaultTimeout int) (action.Action, error) {
	...
	var r1 error
	if returnFunc, ok := ret.Get(0).(func(*types.StopAction, services.ServiceLocator, int) (action.Action, error)); ok {
		return returnFunc(config, sl, defaultTimeout)
	}
	if returnFunc, ok := ret.Get(0).(func(*types.StopAction, services.ServiceLocator, int) action.Action); ok {
	...
	if returnFunc, ok := ret.Get(1).(func(*types.StopAction, services.ServiceLocator, int) error); ok {
...
func (_c *MockMaker_Make_Call) Run(run func(config *types.StopAction, sl services.ServiceLocator, defaultTimeout int)) *MockMaker_Make_Call {
	_c.Call.Run(func(args mock.Arguments) {
		var arg0 *types.StopAction
		if args[0] != nil {
			arg0 = args[0].(*types.StopAction)
		}
...
func (_c *MockMaker_Make_Call) RunAndReturn(run func(config *types.StopAction, sl services.ServiceLocator, defaultTimeout int) (action.Action, error)) *MockMaker_Make_Call {
	_c.Call.Return(run)
	return _c
}
